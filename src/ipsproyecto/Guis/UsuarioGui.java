...
public class UsuarioGui extends javax.swing.JFrame {
    ...
    private void btnPedirTurnoActionPerformed(java.awt.event.ActionEvent evt) {//
        // consultar turno
        SolicitarTurno solicitarTurno = new SolicitarTurno();
        solicitarTurno.setVisible(true);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        // validacion edad que sea numerica Integer
        if (!Edad.matches("[0-9]*")) {
            JOptionPane.showMessageDialog(this, "INGRESE SOLO NUMEROS EN EDAD");
            return;
        }

        Integer NewEdad = Integer.parseInt(Edad);
        paciente = new Paciente(Cedula, Nombre, Apellidos, Telefono,
                NewEdad, condicion);
        ...
        paciente.setCondicionEspecial(condicion);

        // Registro de paciente
        try {
            RegistroPacientes objRegistro = RegistroPacientes.getInstancia();
            objRegistro.agregarPaciente(paciente);
